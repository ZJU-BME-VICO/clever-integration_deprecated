...
public class Patient extends Entity {
	...
	public String getPatientHealthcarePropertyCode() {
		return patientHealthcarePropertyCode;
	}

	public void setPatientHealthcarePropertyCode(
			String patientHealthcarePropertyCode) {
		this.patientHealthcarePropertyCode = patientHealthcarePropertyCode;
	}

	public String getPatientHealthcarePropertyName() {
		return patientHealthcarePropertyName;
	}

	public void setPatientHealthcarePropertyName(
			String patientHealthcarePropertyName) {
