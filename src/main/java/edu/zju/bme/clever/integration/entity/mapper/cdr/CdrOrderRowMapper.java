...
public class CdrOrderRowMapper implements RowMapper<Order> {
	...
	public Order mapRow(ResultSet rs, int rowNum)
		...
		o.setDosage(RowMapperUtil.getFloat(rs, CdrOrderRowMapper.openEHR_EHR_INSTRUCTION_order.dosage.toString()));
		...
		o.setStartDateTime(RowMapperUtil.getDateTime(rs.getString(CdrOrderRowMapper.openEHR_EHR_INSTRUCTION_order.start_date_time.toString())));
		o.setStopDateTimePlan(RowMapperUtil.getDateTime(rs.getString(CdrOrderRowMapper.openEHR_EHR_INSTRUCTION_order.stop_date_time_plan.toString())));
		o.setStopDateTime(RowMapperUtil.getDateTime(rs.getString(CdrOrderRowMapper.openEHR_EHR_INSTRUCTION_order.stop_date_time.toString())));
		...
		o.setStartOrderEnterDateTime(RowMapperUtil.getDateTime(rs.getString(CdrOrderRowMapper.openEHR_EHR_INSTRUCTION_order.start_order_enter_date_time.toString())));
		o.setStopOrderEnterDateTime(RowMapperUtil.getDateTime(rs.getString(CdrOrderRowMapper.openEHR_EHR_INSTRUCTION_order.stop_order_enter_date_time.toString())));
		...
		o.setLastPerformDateTime(RowMapperUtil.getDateTime(rs.getString(CdrOrderRowMapper.openEHR_EHR_INSTRUCTION_order.last_perform_date_time.toString())));
		o.setLastActingDateTime(RowMapperUtil.getDateTime(rs.getString(CdrOrderRowMapper.openEHR_EHR_INSTRUCTION_order.last_accting_date_time.toString())));
		o.setCheckDateTime(RowMapperUtil.getDateTime(rs.getString(CdrOrderRowMapper.openEHR_EHR_INSTRUCTION_order.check_date_time.toString())));
